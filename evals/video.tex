...
\begin{center}
  \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} c @{\extracolsep{\fill}} r}
    \large \textbf{\textsf{ Teaching Video }} &
...
%{\large \textit{Fall 2019:} \textbf{EE149/249A - Introduction to Embedded Systems} (UC Berkeley)}

In Fall 2019, I gave a guest lecture for the EE149/249 Introduction to Embedded
Systems class at UC Berkeley. I covered a lecture on memory architectures, with
a particular emphasis for how they work in an embedded systems context. The
class had roughly 80 students.

\bigskip
{\large \url{https://www.youtube.com/watch?v=9iE4Y2zt4v4}}

\bigskip
\textit{Note:} this link should be available for the foreseeable future, but if
it is removed at the end of the semester, feel free to email me and I can
provide a video file directly.
